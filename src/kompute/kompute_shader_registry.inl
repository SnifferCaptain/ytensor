...
inline const std::vector<ShaderBinding>& ytensorBaseMathShaderBindings() {
    static const std::vector<ShaderBinding> bindings = {
        ...
        {"operator+", "include/kompute/shaders/binary_arith_float.comp.hlsl", "fadd_main"},
        {"operator+=", "include/kompute/shaders/binary_arith_float.comp.hlsl", "fadd_main"},
        {"operator-", "include/kompute/shaders/binary_arith_float.comp.hlsl", "fsub_main"},
        {"operator-=", "include/kompute/shaders/binary_arith_float.comp.hlsl", "fsub_main"},
        {"operator*", "include/kompute/shaders/binary_arith_float.comp.hlsl", "fmul_main"},
        {"operator*=", "include/kompute/shaders/binary_arith_float.comp.hlsl", "fmul_main"},
        {"operator/", "include/kompute/shaders/binary_arith_float.comp.hlsl", "fdiv_main"},
        {"operator/=", "include/kompute/shaders/binary_arith_float.comp.hlsl", "fdiv_main"},
        {"operator%(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "mod_main"},
        {"operator%=(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "mod_main"},
        {"operator&(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "and_main"},
        {"operator&=(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "and_main"},
        {"operator|(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "or_main"},
        {"operator|=(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "or_main"},
        {"operator^(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "xor_main"},
        {"operator^=(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "xor_main"},
        {"operator<<(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "shl_main"},
        {"operator<<=(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "shl_main"},
        {"operator>>(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "shr_main"},
        {"operator>>=(int)", "include/kompute/shaders/binary_arith.comp.hlsl", "shr_main"},
